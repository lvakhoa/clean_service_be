...
namespace CleanService.Migrations
{
    ...
    [Migration("20241023114921_TransformEnumToString")]
    partial class TransformEnumToString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanService.Src.Models.Contracts", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 23, 18, 49, 18, 588, DateTimeKind.Local).AddTicks(4932));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Notifications", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 23, 18, 49, 18, 588, DateTimeKind.Local).AddTicks(6060));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Users", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 23, 18, 49, 18, 586, DateTimeKind.Local).AddTicks(8631));
