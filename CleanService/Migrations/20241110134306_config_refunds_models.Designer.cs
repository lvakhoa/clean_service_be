            ...
            modelBuilder.Entity("CleanService.Src.Models.BlacklistedUsers", b =>
                {
                    ...
                    b.Property<DateTime>("BlacklistedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(8702));
            ...
            modelBuilder.Entity("CleanService.Src.Models.BookingContracts", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(5912));
            ...
            modelBuilder.Entity("CleanService.Src.Models.BookingDetails", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(3939));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Bookings", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(1401));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(1851));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Contracts", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(6485));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(6807));
            ...
            modelBuilder.Entity("CleanService.Src.Models.DurationPrice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(9154));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Feedbacks", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(7126));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(7477));
            ...
            modelBuilder.Entity("CleanService.Src.Models.HelperAvailability", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(5891));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(6327));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Helpers", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(3160));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(3568));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Notifications", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(9530));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Refunds", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 997, DateTimeKind.Local).AddTicks(7952));
            ...
            modelBuilder.Entity("CleanService.Src.Models.RoomPricing", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(8410));
            ...
            modelBuilder.Entity("CleanService.Src.Models.ServiceCategories", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(6851));
            ...
            modelBuilder.Entity("CleanService.Src.Models.ServiceTypes", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(7646));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Users", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(162));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 11, 10, 20, 43, 5, 996, DateTimeKind.Local).AddTicks(652));
