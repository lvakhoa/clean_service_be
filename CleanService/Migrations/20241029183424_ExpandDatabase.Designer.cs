...
namespace CleanService.Migrations
{
    ...
    [Migration("20241029183424_ExpandDatabase")]
            ...
            modelBuilder.Entity("CleanService.Src.Models.BlacklistedUsers", b =>
                {
                    ...
                    b.Property<DateTime>("BlacklistedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 435, DateTimeKind.Local).AddTicks(1825));
            ...
            modelBuilder.Entity("CleanService.Src.Models.BookingDetails", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 434, DateTimeKind.Local).AddTicks(8147));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Bookings", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 434, DateTimeKind.Local).AddTicks(4734));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 434, DateTimeKind.Local).AddTicks(5455));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Complaints", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 435, DateTimeKind.Local).AddTicks(1151));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Contracts", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 434, DateTimeKind.Local).AddTicks(9801));
            ...
            modelBuilder.Entity("CleanService.Src.Models.DurationPrice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 434, DateTimeKind.Local).AddTicks(2146));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Helpers", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 433, DateTimeKind.Local).AddTicks(6441));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 433, DateTimeKind.Local).AddTicks(7070));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Notifications", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 435, DateTimeKind.Local).AddTicks(3017));
            ...
            modelBuilder.Entity("CleanService.Src.Models.RoomPricing", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 434, DateTimeKind.Local).AddTicks(994));
            ...
            modelBuilder.Entity("CleanService.Src.Models.ServiceCategories", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 433, DateTimeKind.Local).AddTicks(8896));
            ...
            modelBuilder.Entity("CleanService.Src.Models.ServiceTypes", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 433, DateTimeKind.Local).AddTicks(9897));
            ...
            modelBuilder.Entity("CleanService.Src.Models.Users", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 433, DateTimeKind.Local).AddTicks(2906));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 10, 30, 1, 34, 24, 433, DateTimeKind.Local).AddTicks(3579));
