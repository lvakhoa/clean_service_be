...
public interface IRequestClient
{
    ...
    public Task<T> PostFormAsync<T>(string uri, Dictionary<string, string> data, string? contentType = "application/json", Dictionary<string, object>? headers = null);
    public Task<Dictionary<string, object>> PostFormAsync(string uri, Dictionary<string, string> data, string? contentType = "application/json", Dictionary<string, object>? headers = null);
